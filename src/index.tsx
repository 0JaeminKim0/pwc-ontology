...
async function processPDFAsImages(fileName: string, fileSize: number): Promise<any> {
  ...
  const mockPageImages = [
    ...
    },
    {
      ...
      type: 'pdf_page_image',
      category: 'document_page_image',
      x: Math.cos((1/5) * 2 * Math.PI) * 250,
      y: Math.sin((1/5) * 2 * Math.PI) * 250,
      z: 20,
      color: '#ffffff',
      label: 'Agenda',
      pageTitle: 'Agenda',
    ...
    },
    {
      ...
      type: 'pdf_page_image',
      category: 'document_page_image',
      x: Math.cos((2/5) * 2 * Math.PI) * 250,
      y: Math.sin((2/5) * 2 * Math.PI) * 250,
      z: 40,
      color: '#ffffff',
      label: '프로젝트 추진 목표',
    ...
    },
    {
      ...
      type: 'pdf_page_image',
      category: 'document_page_image',
      x: Math.cos((3/5) * 2 * Math.PI) * 250,
      y: Math.sin((3/5) * 2 * Math.PI) * 250,
      z: 60,
      color: '#ffffff',
      label: '구현 계획',
      pageTitle: '구현 계획',
    ...
    },
    {
      ...
      type: 'pdf_page_image',
      category: 'document_page_image',
      x: Math.cos((4/5) * 2 * Math.PI) * 250,
      y: Math.sin((4/5) * 2 * Math.PI) * 250,
      z: 80,
      color: '#ffffff',
      label: '기대 효과',
      pageTitle: '기대 효과',
  ...
  mockPageImages.forEach((page, pageIndex) => {
    const baseRadius = 350 + pageIndex * 50
    ...
    page.metadata.consultingInsights?.forEach((insight: string, insightIndex: number) => {
      ...
      consultingInsightNodes.push({
        ...
        x: Math.cos(angle) * (baseRadius + 80),
        y: Math.sin(angle) * (baseRadius + 80),
        z: 80 + insightIndex * 25,
        color: '#f39c12',
        size: 10,
        isNew: true,
        sourcePageId: page.id,
